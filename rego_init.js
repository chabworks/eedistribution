...
//Login to see price and checkout
...
// setTimeout(process.exit,((1000*60*60*2.5) - (1000*60*6.5)))

// var shell = require('shelljs');
// shell.exec('taskkill /f /im chrome.exe & ver > nul')


const buffers = fs.readFileSync("rego_inject.js");
...
if (all__proxies.length)
    ...
    await page.goto("https://regowholesale.com", {waitUntil: 'load', timeout: 0});
    fs.appendFile('log.txt', new Date().toISOString()+" --> First page List page triggred"+"\n", (err) => {if (err) console.log(err);  });
